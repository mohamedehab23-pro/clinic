...
<>
<div >
<div className='bg-white py-3 min-w-md dark:text-white  text-start dark:bg-gray-800 lg:text-end px-6 rounded-2xl border border-gray-300 '>
<div className='flex flex-col lg:flex-row gap-1 justify-end'>
