...
export default function Child({product}) {
  return (
   <>
   <div className='w-1/3 py-7  px-10 rounded-2xl space-x-2 relative bg-gray-100'>
<p className='text-xl font-semibold '>id: {product.id}</p>
<button className='absolute top-4 bg-red-500 text-white p-2 rounded-2xl right-4'> On Sale </button>
