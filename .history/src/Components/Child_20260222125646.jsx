...
export default function Child(props) {
    let{id,product,onsale,count,deleteProduct}=props.product
  return (
   <>
...
<button  onClick={()=>{deleteProduct(id)}} className='bg-red-600 cursor-pointer text-white p-2 w-full my-3 hover:bg-red-500 rounded-2xl'>Delete</button>
