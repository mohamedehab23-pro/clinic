...
export default function Child(props) {
    let{id,product,onsale,count}=props.product
  return (
   <>
...
<button onClick={()=>props.UpdeateProduct(props.index)} className='bg-yellow-500 text-white cursor-pointer p-2 w-full my-1 hover:bg-yellow-400 rounded-2xl'>Update</button>
   </div>
