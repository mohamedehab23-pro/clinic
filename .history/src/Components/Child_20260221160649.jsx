...
<button className='bg-red-600 text-white p-2 w-full m-3 hover:bg-red-500 rounded-2xl'>Delete</button>
<button className='bg-yellow-600 text-white p-2 w-full m-3 hover:bg-yellow-400 rounded-2xl'>Update</button>
   </div>
