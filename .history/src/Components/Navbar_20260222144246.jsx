...
export default function Navbar({setDarkMode,darkMode}) {
  ...
  return (
    <div className='py-3 shadow sticky top-0 w-full dark:bg-gray-700 bg-white/50'>
<div className="container px-3 lg:p-0 mx-auto flex items-center justify-between">
<div>
  <Button to={'/'} bg={'bg-blue-500'} padding={'p-2'} hover={'hover:bg-blue-600'} color={'text-white'} text={'أحجز الان'}/>
</div>
<div>
  <ul className='lg:flex nav dark:text-white/50 gap-5 hidden'>
    <li className=' '><NavLink to={''}>خدمات</NavLink></li>
    <li ><NavLink to={'/about'}>أراء العملاء</NavLink></li>
    <li ><NavLink to={'/contact'}>احجز</NavLink></li>
    <li ><NavLink to={'ertyuj'}>تواصل</NavLink></li>
  </ul>
</div>
