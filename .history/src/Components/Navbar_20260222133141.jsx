...
<div className='lg:hidden'>
  <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>setNavToggle(!n)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="cursor-pointer size-6">
