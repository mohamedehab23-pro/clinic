...
<div className='py-8  px-3 min-w-md rounded-2xl ms-2 '>
...
<div className="cardContent py-2">
 ...
 <Link to={'/booking'} className="w-full"> <button className='p-2 rounded-xl border my-2 dark:hover:bg-gray-500 dark:text-white border-gray-300 w-full cursor-pointer hover:bg-gray-200'>
