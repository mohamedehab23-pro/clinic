...
<h2 className='text-2xl font-bold'>count: {product.count}</h2>
<button  onClick={()=>{deleteProduct(product.id)}} className='bg-red-600 cursor-pointer text-white p-2 w-full my-3 hover:bg-red-500 rounded-2xl'>Delete</button>
<button onClick={()=>{updateProduct(index)}} className='bg-yellow-500 text-white cursor-pointer p-2 w-full my-1 hover:bg-yellow-400 rounded-2xl'>Update</button>
   </div>
