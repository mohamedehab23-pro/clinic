...
export default function HomePage() {
  return (
    <div className='dark:bg-gray-800 bg-gradient-to-l from-background/90 via-background/50 to-transparent min-h-screen p-3'>
...
<p className='text-gray-600 pt-3 text-lg'>احجز موعدك الآن بسهولة</p>
  <div className='flex gap-3 justify-center mt-4'>
      <Button to={'/about'} padding={'p-3'} bg={'bg-white '} color={'text-black'} text={'اتصل بنا'}/>
