...
<p className='text-gray-600 dark:text-white pt-3 text-lg'> نقدم أحدث تقنيات علاج الأسنان بأيدي أطباء متخصصين</p>
  ...
  <div className='flex flex-col lg:flex-row gap-4 justify-center pt-7'>
<button className='p-2 bg-blue-500 rounded-full shadow text-white'> أحدث الأجهزة الطبية</button>
<button className='p-2 bg-blue-500 rounded-full shadow text-white'> أطباء متخصصون  </button>
<button className='p-2 bg-blue-500 rounded-full shadow text-white'> حجز سريع بدون انتظار  </button>
  </div>
