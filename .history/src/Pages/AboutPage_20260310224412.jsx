...
<Header text={'عن الدكتور'}/>
    <div  className='min-h-[50vh] py-8 px-7 flex justify-center '>
<div className="max-w-md lg:min-w-full h-fit p-2 rounded-2xl dark:border shadow hover:shadow-2xl dark:border-gray-400 text-end">
