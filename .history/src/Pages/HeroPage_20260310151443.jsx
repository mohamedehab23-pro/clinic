...
<p className='text-gray-600 dark:text-white pt-3 text-lg'> نقدم أحدث تقنيات علاج الأسنان بأيدي أطباء متخصصين</p>
  ...
  <div className='flex flex-col lg:flex-row gap-4 justify-center py-'>
<button className='p-1 bg-blue-600 rounded-full shadow text-white'> أحدث الأجهزة الطبية</button>
<button className='p-1 bg-blue-600 rounded-full shadow text-white'> أطباء متخصصون  </button>
<button className='p-1 bg-blue-600 rounded-full shadow text-white'> حجز سريع بدون انتظار  </button>
  </div>
