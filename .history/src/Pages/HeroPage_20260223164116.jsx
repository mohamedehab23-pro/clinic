...
export default function HomePage() {
  return (<>
    <div className='bg-linear-to-r from-white to-blue-500/80 dark:bg-linear-to-r dark:from-gray-400 dark:to-blue-600  min-h-screen  p-3'>
...
<p className='text-gray-600 pt-3 text-lg'>احجز موعدك الآن بسهولة</p>
  <div className='flex gap-3 justify-center mt-4'>
      <Buttons to={`https://wa.me/01090424304`} padding={'p-3'} bg={'bg-gray-300 '} hover={'hover:bg-gray-400'} color={'text-black'} text={'اتصل بنا'}/>
