...
<button className='p-2 bg-blue-400 rounded-full shadow text-white'> أحدث الأجهزة الطبية</button>
<button className='p-2 bg-blue-400 rounded-full shadow text-white'> أطباء متخصصون  </button>
<button className='p-2 bg-blue-400 rounded-full shadow text-white'> حجز سريع بدون انتظار  </button>
  </div>
