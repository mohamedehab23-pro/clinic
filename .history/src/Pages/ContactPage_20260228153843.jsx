...
<div className='w-full flex flex-col space-y-5 items-center justify-center h-screen bg-red-200'>
  ...
  <div className="flex gap-4">
    <Button to={'/'} bg={'bg-blue-500'} padding={'p-3'} hover={'hover:bg-blue-600'} color={'text-white'} text={'واتساب'}/>
    <Button to={'/'} bg={'bg-blue-500'} padding={'p-3'} hover={'hover:bg-blue-600'} color={'text-white'} text={'face'}/>
