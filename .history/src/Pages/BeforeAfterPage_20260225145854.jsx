...
<ReviewsDev content={'شكراً عيادة أسنان زرتها. الخدمة والاهتمام فوق الممتاز.”'} patient={'نورا أحمد'} statue={'مريض'}/>
<ReviewsDev content={' لفريق العمل على الاحترافية والراحة أثناء الجلسات'} patient={'نورا أحمد'} statue={'مريضة'}/>
  </div>
