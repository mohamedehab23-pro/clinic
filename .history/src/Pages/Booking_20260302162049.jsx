        ...
        <div className='flex justify-center items-center'>
          ...
          <div className='  p-6 dark:text-white dark:bg-gray-800 bg-white rounded-xl min-w-md border border-gray-200'>
            ...
            {errors.service&& touchedFields.service&& (<p className='text-red-600 '>{errors.service?.message}</p>)}
              ...
              <input    type="date" className={`p-2 rounded-xl shadow border border-gray-300 ${errors.time&& touchedFields.time && (<p className='text-r'>{errors.time?.message}</p>)}`} {...register('time')}/>
