...
<p className='text-gray-600 dark:text-white pt-3 text-lg'>احجز موعدك الآن بسهولة</p>
  <div className='flex gap-3 justify-center mt-4'>
      <Buttons to={`https://wa.me/${clinicNumber}?text=${encodeURIComponent(message)}`} padding={'p-3'} bg={'bg-gray-300 '} hover={'hover:bg-gray-400'} color={'text-black'} text={'ارسل رساله'}/>
