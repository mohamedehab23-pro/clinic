...
const sendData = (userData) => {
  ...
  const formattedDate = <date className="toLocaleDateString"></date>('en-GB');

  // رقم العيادة (حط رقمك هنا بصيغة دولية)
  const clinicNumber = "201234567890"; // مثال: 20 + رقمك بدون صفر
...
<a href={`https://wa.me/01090424304?text=text`}> ارسال عبر الواتساب</a>
