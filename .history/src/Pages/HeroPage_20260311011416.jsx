...
export default function HomePage() {
  ...
  return (<>
   {setTimeout(()=>(<Loading/>,))} <div id='home' className=' bg-linear-to-r from-blue-100 to-white dark:bg-linear-to-r dark:from-gray-800 dark:to-gray-800  min-h-screen  p-3'>
