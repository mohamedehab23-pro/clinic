...
<p className='text-gray-600 dark:text-white pt-3 text-lg'> نقدم أحدث تقنيات علاج الأسنان بأيدي أطباء متخصصين</p>
  ...
  <div className='flex flex-col lg:flex-row gap-4 ju'>
<button className='p-1 bg-blue-400 rounded-full shadow'> أحدث الأجهزة الطبية</button>
<button className='p-1 bg-blue-400 rounded-full shadow'> أطباء متخصصون  </button>
<button className='p-1 bg-blue-400 rounded-full shadow'> حجز سريع بدون انتظار  </button>
  </div>
