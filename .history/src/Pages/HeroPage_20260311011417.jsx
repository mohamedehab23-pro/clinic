...
export default function HomePage() {
  ...
  return (<>
   {setTimeout(()=>(<Loading/>,400))} <div id='home' className=' bg-linear-to-r from-blue-100 to-white dark:bg-linear-to-r dark:from-gray-800 dark:to-gray-800  min-h-screen  p-3'>
...
<button className='p-2 bg-gray-200 lg:mx-0  mx-auto w-fit rounded-full shadow text-black'>✔ حجز سريع بدون انتظار  </button>
  </div>
