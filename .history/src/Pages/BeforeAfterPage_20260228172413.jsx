...
export default function Reviews() {
  return (
    <>
    <div className='min-h-[50vh] dark:text-white dark:bg-gray-800 w-3/4 py-12 mx-auto'>
<Header text={'آراء العملاء'}/> 
<div className="container mx-auto py-4">
  
  <div className="flex justify-center text-end space-y-5 lg:space-y-0 lg:space-x-5 items-center flex-col lg:flex-row ">
