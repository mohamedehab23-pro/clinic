...
export default function Services() {
  return (
   ...
   <Header  text={'خدماتنا'}/>
  <div className="flex flex-col py-2 text-center lg:text-end lg:flex-row gap-3">
    {/* <Card  body={' زراعات حديثة لاستبدال الأسنان المفقودة بدقة واحترافية عاليه'} head={'زراعة الأسنان '} 
