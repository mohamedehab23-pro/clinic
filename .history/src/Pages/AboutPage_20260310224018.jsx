...
<Header text={'عن الدكتور'}/>
    <div  className='min-h-[50vh] py-8 flex flex-col lg:flex-row lg:justify-center gap-8 lg:justify-end p-4 '>
<div className="max-w-md lg:min-w-2xl h-fit p-2 rounded-2xl dark:border shadow hover:shadow-2xl dark:border-gray-400 text-end">
