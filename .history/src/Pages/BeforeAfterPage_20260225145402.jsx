...
export default function BeforeAfterPage() {
  return (
    <>
    <div className='min-h-[50vh] dark:text-white dark:bg-gray-800 w-3/4 py-8 mx-auto'>
<Header text={'آراء العملاء'}/> 
<div className="container mx-auto py-4">
  
  <div className="flex justify-center space-y-5 space-x-5 items-center flex-col lg:flex-row ">
{/* <div >
