...
<div className='flex flex-col gap-3 items-center'>
      <div className='flex gap-3'>
        <div>
          ...
          <img src={before} className='w-40 lg:w-70 blur hover:blur-none rounded-2xl duration-700' alt="" />
        </div>
        <div>
          <p className='text-center py-4 text-2xl'>بعد</p>

        <img src={after} className='w-40 lg:w-70 blur hover:blur-none rounded-2xl duration-700' alt="" />
        </div>
      </div>
      <div className='flex gap-3'>
        <img src={secondbefore} className='w-40 lg:w-70 blur hover:blur-none rounded-2xl duration-700' alt="" />
        <img src={secondafter} className='w-40 lg:w-70 blur hover:blur-none rounded-2xl duration-700' alt="" />
      </div>
       {/* <div >
