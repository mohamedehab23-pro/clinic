...
<div className='flex flex-col gap-3 items-center'>
      <div className='flex gap-3'>
        <div>
          <p className='text-center py-3 text-2xl'>قبل</p>

          <img src={before} className='w-40 lg:w-70 blur hover:blur-none duration-100' alt="" />
        </div>
        <div>
          <p className='text-center py-2 text-2xl'>بعد</p>

        <img src={after} className='w-40 lg:w-70 blur hover:blur-none duration-100' alt="" />
        </div>
      </div>
      <div className='flex gap-3'>
        <img src={secondbefore} className='w-40 lg:w-70 blur hover:blur-none duration-100' alt="" />
        <img src={secondafter} className='w-40 lg:w-70 blur hover:blur-none duration-100' alt="" />
      </div>
       {/* <div >
