...
<p className='text-gray-600 dark:text-white pt-3 text-lg'> نقدم أحدث تقنيات علاج الأسنان بأيدي أطباء متخصصين</p>
  <div className='flex gap-3 justify-center mt-4'>
      <Buttons to={`https://wa.me/${number}?text=${message}`} padding={'p-3'} bg={'bg-gray-300 '} hover={'hover:bg-gray-400'} color={'text-black'} text={' تواصل عبر واتساب'}/>
...
<button className='p-2 bg-gray-500 lg:mx-0  mx-auto w-fit rounded-full shadow text-white'>✔ أحدث الأجهزة الطبية</button>
<button className='p-2 bg-gray-500 lg:mx-0  mx-auto w-fit rounded-full shadow text-white'>✔ أطباء متخصصون  </button>
<button className='p-2 bg-gray-500 lg:mx-0  mx-auto w-fit rounded-full shadow text-white'>✔ حجز سريع بدون انتظار  </button>
  </div>
