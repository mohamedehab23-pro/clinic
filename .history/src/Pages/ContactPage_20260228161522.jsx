...
<div className="flex flex-col py- lg:flex-row items-center py-8 justify-between">
<div className='w-full flex ms-6 justify-center items-center  '>
...
<div className='w-full flex me-6 flex-col space-y-5 items-center justify-center '>
  <p>القاهرة، مصر</p>
