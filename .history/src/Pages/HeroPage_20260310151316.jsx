...
<button className='p-1 bg-blue-400 rounded-2xl shadow'> أحدث الأجهزة الطبية</button>
<button className='p-1 bg-blue-400 rounded-2xl shadow'> أطباء متخصصون  </button>
<button className='p-1 bg-blue-400 rounded-2xl shadow'> حجز سريع بدون انتظار  </button>
  </div>
