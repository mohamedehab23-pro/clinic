...
<ReviewsDev content={'شكراً لفريق العمل على الاحترافية والاهتمام أثناء الجلسات.”'} patient={'نورا أحمد'} statue={'مريض'}/>
<ReviewsDev content={'   على  والراحة  '} patient={'نورا أحمد'} statue={'مريضة'}/>
  </div>
