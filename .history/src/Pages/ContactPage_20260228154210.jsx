...
<div className='w-full flex flex-col space-y-5 items-center justify-center h-screen '>
  ...
  <div className="flex gap-2">
    ...
    <Button className='p-5' variant='flat'>  mohamed.ehabyoussef22@gmail.com</Button>
    </Link>
    <Buttons to={'/'} bg={'bg-blue-500'} padding={'p-2'} hover={'hover:bg-blue-600'} color={'text-white'} text={'واتساب'}/>
