        ...
        <div className='flex justify-center items-center'>
          ...
          <div className='  p-6 dark:text-white dark:bg-gray-800 bg-white rounded-xl min-w-md border border-gray-200'>
            <form onSubmit={handleSubmit(sendData)} className='flex text-end flex-col gap-4'>
              ...
              <Input errorMessage={errors.name?.message} isInvalid={Boolean(errors.name)} variant='bordered' {...register('name',{required:'name is required'})} id='name' />
              <label htmlFor='mobile'>رقم الموبايل</label>
              <Input errorMessage={errors.phone?.message} isInvalid={Boolean(errors.phone)} variant='bordered' {...register('phone',{required:'phone is required'})} id='mobile' />
              ...
              <input errorMessage={errors.time?.message} isInvalid={Boolean(errors.time)} type="date" className='p-2 rounded-xl shadow border border-gray-300' {...register('time',{required:'time is required'})}/>
