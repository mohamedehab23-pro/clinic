...
<p className='text-gray-600 dark:text-white pt-3 text-lg'> نقدم أحدث تقنيات علاج الأسنان بأيدي أطباء متخصصين</p>
  <div className='flex gap-3 justify-center mt-4'>
      <Buttons to={`https://wa.me/${number}?text=${message}`} padding={'p-3'} bg={'bg-gray-300 '} color={'text-black'} text={' تواصل عبر واتساب'}/>
    
  <Buttons to={'/#booking'} bg={'bg-blue-500'} padding={'p-3'}  color={'text-white'} text={'أحجز الان'}/>
  </div>
