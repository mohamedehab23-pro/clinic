        ...
        <div className='flex justify-center items-center'>
          ...
          <div className='  p-6 dark:text-white dark:bg-gray-800 bg-white rounded-xl min-w-md border border-gray-200'>
            <form onSubmit={handleSubmit(sendData)} className='flex text-end flex-col gap-4'>
              ...
              <Input errorMessage={errors.name?.message} isInvalid={errors.name} variant='bordered' {...register('name',{required:'name is required'})} id='name' />
              ...
              <select errorMessage={errors.service?.message} isInvalid={errors.service} className='p-2 rounded-xl shadow border border-gray-300' {...register('service',{required:'you must select one'})} id="jobs">
                <option value=""></option>
