...
<div className='w-full flex bg-amber-200 justify-center items-center  h-screen '>
...
<div className='w-full flex bg-red-200 flex-col space-y-5 items-center justify-center '>
  <p>القاهرة، مصر</p>
