...
<button className='p-2 bg-blue-500 lg:mx-0  mx-auto w-fit rounded-full shadow text-white'> أحدث الأجهزة الطبية</button>
<button className='p-2 bg-blue-500 lg:mx-0  mx-auto w-fit rounded-full shadow text-white'> أطباء متخصصون  </button>
<button className='p-2 bg-blue-500 lg:mx-0  mx-auto w-fit rounded-full shadow text-white'> حجز سريع بدون انتظار  </button>
  </div>
