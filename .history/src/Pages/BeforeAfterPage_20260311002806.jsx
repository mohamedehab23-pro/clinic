...
<div className='flex flex-col gap-7 items-center'>
      ...
      <div className='flex gap-3'>
        <img src={secondbefore} className='w-40 lg:w-70 lg:blur hover:blur-none rounded-2xl duration-600' alt="bad teeth" />
        <img src={secondafter} className='w-40 lg:w-70 lg:blur hover:blur-none rounded-2xl duration-600' alt="clean teeth" />
      </div>
