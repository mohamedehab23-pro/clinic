...
<div className='flex flex-col gap-3 items-center'>
      <div className='flex gap-3'>
        <img src={before} className='w-40 lg:w-70 blur hover:blur-none du' alt="" />
        <img src={after} className='w-40 lg:w-70 blur hover:blur-none du' alt="" />
      </div>
      <div className='flex gap-3'>
        <img src={secondbefore} className='w-40 lg:w-70 blur hover:blur-none du' alt="" />
        <img src={secondafter} className='w-40 lg:w-70 blur hover:blur-none du' alt="" />
      </div>
       {/* <div >
