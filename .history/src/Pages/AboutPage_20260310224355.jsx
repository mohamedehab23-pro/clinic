...
<Header text={'عن الدكتور'}/>
    <div  className='min-h-[50vh] py-8 px-7 flex justify-end '>
<div className="max-w-md lg:min-w-8xl h-fit p-2 rounded-2xl dark:border shadow hover:shadow-2xl dark:border-gray-400 text-end">
