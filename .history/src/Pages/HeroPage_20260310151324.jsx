...
<button className='p-1 bg-blue-400 rounded-pill shadow'> أطباء متخصصون  </button>
<button className='p-1 bg-blue-400 rounded-pill shadow'> حجز سريع بدون انتظار  </button>
  </div>
