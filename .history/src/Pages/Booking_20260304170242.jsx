        ...
        <div className='flex justify-center items-center'>
          ...
          <div className='  p-6 dark:text-white dark:bg-gray-800 bg-white rounded-xl min-w-md border border-gray-200'>
            <form onSubmit={handleSubmit(sendData)} className='flex text-end flex-col gap-4'>
              ...
              <Input className='dark:border-white' errorMessage={errors.name?.message} isInvalid={errors.name&& touchedFields.name} variant='bordered' {...register('name')} id='name' />
              <label htmlFor='mobile'>رقم الموبايل</label>
              <Input className='dark:border-white' errorMessage={errors.phone?.message} isInvalid={errors.phone&& touchedFields.phone} variant='bordered' {...register('phone')} id='mobile' />
