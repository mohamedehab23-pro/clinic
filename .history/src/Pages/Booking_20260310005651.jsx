        ...
        <div className='flex justify-center  items-center'>
          ...
          <div className='  p-6 dark:text-white dark:bg-gray-800 bg-white rounded-xl lg:min-w-md  w-sm border border-gray-200'>
            ...
            {errors.service&& touchedFields.service&& (<p className='text-red-600 text-sm '>{errors.service?.message}</p>)}
              ...
              <input    type="date" className={`p-2 rounded-xl shadow border text-md border-gray-300 
                ${errors.time ?'border-red-500':'border-gray-300' }`} {...register('time')}/>
             {errors.time&& touchedFields.time&& <p className='text-red-600 text-md'>{errors.time?.message}</p>}
