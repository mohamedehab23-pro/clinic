...
<div className="min-w-md p-2 rounded-2xl shadow text-end">
    ...
    <p>بدأ الدكتور أحمد خفاجي رحلته في طب الأسنان التجميلي كطبيب مقيم في قسم التركيبات وتجميل الأسنان بكلية طب الأسنان كأحد أعضاء هيئة التدريس. ثم تخصص في تركيبات وتجميل الأسنان بدرجة الماجستير من جامعة القاهرة.
