...
const schema=zod.object({
  name:zod.string().nonempty('الاسم مطلوب').min(3,'name must be at least 3'),
  phone:zod.string().nonempty('رقم الهاتف مطلوب').regex(/^01[0125][0-9]{8}$/,'phone must be egyptian number'),
