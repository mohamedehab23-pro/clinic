...
<Header text={'احجز موعدك'} />
        <div className='flex justify-center  items-center'>
          ...
          <div className='  p-6 dark:text-white dark:bg-gray-800 bg-white rounded-xl lg:min-w-md  w-sm border border-gray-200'>
            ...
            {errors.service&& touchedFields.service&& (<p className='text-red-600 text-xs '>{errors.service?.message}</p>)}
             ...
             {errors.time&& touchedFields.time&& <p className='text-red-600 text-xs'>{errors.time?.message}</p>}
