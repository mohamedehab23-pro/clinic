...
export default function WhyUs() {
  return (
    <div>
   <div id='services' className='min-h-[50vh] w-3/4 bg-gray-200 mx-auto'>
...
<p className='text-5xl text-blue-500 font-bold'>أجهزة حديثة</p>
<p className='text-xl py-2'> تقنية متطورة</p>
</div>
<div className='rounded-2xl text-center border hover:shadow-2xl shadow w-full p-6 border-gray-200'>
