...
<button className='p-1 bg-blue-400 rounded-full shadow text-white'> أحدث الأجهزة الطبية</button>
<button className='p-1 bg-blue-400 rounded-full shadow text-white'> أطباء متخصصون  </button>
