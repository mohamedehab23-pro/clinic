...
<ReviewsDev content={'شكراً لفريق العمل على الاحترافية والاهتمام فوق الممتاز.”'} patient={'نورا أحمد'} statue={'مريض'}/>
<ReviewsDev content={'   على  والراحة أثناء الجلسات'} patient={'نورا أحمد'} statue={'مريضة'}/>
  </div>
