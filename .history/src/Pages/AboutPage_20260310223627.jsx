...
<div className="max-w-md h-fit p-2 rounded-2xl dark:border shadow hover:shadow-2xl dark:border-gray-400 text-end">
...
الدكتور أحمد عب متخصص في حالات الابتسامة الكاملة والعدسات التجميلية وحالات إعادة تأهيل الفم بالكامل ومسؤول عن علاجات الأسنان من تركيبات وحشوات تجميلية.</p>
</div>
    </div>
  </div>
