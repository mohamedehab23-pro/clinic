...
<ReviewsDev content={'شكراً لفريق العمل على الاحترافية والاهتمام أثناء الممتاز.”'} patient={'نورا أحمد'} statue={'مريض'}/>
<ReviewsDev content={'   على  والراحة  الجلسات'} patient={'نورا أحمد'} statue={'مريضة'}/>
  </div>
